...
print(arquivo.read())
print(arquivo.read()) # Nada é retornado. O Python utiliza um recurso para ztrabalhar com arquivos chamado cursor. Esse cursor funciona como o cursor quando estamos escrevendo.
